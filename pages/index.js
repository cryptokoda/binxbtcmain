  ...
  return (
    <Layout home>
      ...
      <section className={utilStyles.headingMd} align="middle">
        ...
        <button onClick={() => {
          window.location.href = 'https://x.com/binxbtc';
        ...
        <section align="middle" className={`${utilStyles.headingMd} ${utilStyles.padding2px} center-content`}>
          <img src="/binxbtcordqraddy.png" align="left" alt="Ordinals QR Code" />
          <img src="/binxbtcbtcqraddy.png" align="left" alt="Bitcoin QR Code" />
          <img src="/binxbtcstxqraddy.png" alt="Stacks QR Code" />
        </section>
      ...
      <section align="middle" className={`${utilStyles.headingMd} ${utilStyles.padding2px}`}>
        ...
        <div align="middle">
          <Link href="marbsintro" target='_blank'><img src="/mrbl1.png" width="60px" height="40px" alt="Marbles Introduction"></img></Link>
        </div>
      </section>
    </Layout>
  );
